...
const getRegionPhoto = (region) =>
  `https://picsum.photos/seed/${encodeURIComponent(region || 'travel')}/1400/500`;
  ...
  return (
    <div className="min-h-screen bg-[#FBF7F0]">
      ...
      <div className="relative h-64 md:h-80 overflow-hidden">
        <img
          src={getRegionPhoto(trip?.region)}
          alt={trip?.region || 'Trip'}
          className="w-full h-full object-cover"
          onError={(e) => { e.target.onerror = null; e.target.src = 'https://picsum.photos/seed/travel/1400/500'; }}
        />
        {/* Gradient overlay */}
